  ...
  const features = [
    {
      ...
      description: 'View grades, attendance, and assignments in one centralized location. Stay connected with student progress.'
    },
    {
      icon: <Book className="w-8 h-8" />,
      title: 'Curriculum Access',
      description: 'Access study materials, syllabus details, and recommended resources for all courses and subjects.'
    },
    {
      icon: <Bell className="w-8 h-8" />,
      title: 'Real-time Notifications',
      description: 'Receive instant updates about grades, assignments, and school-wide announcements.'
    },
    {
      icon: <Edit className="w-8 h-8" />,
      title: 'Assignment Management',
      description: 'Submit assignments online, receive feedback, and track due dates all in one place.'
    },
    {
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <div className="space-y-2">
                ...
                <Link to="/profile" className="block text-white/80 hover:text-white">Parent Portal</Link>
            ...
            <div>
              ...
              <div className="space-y-2 text-white/80">
                ...
                <p>Email: info@scholastichub.edu</p>
              </div>
            </div>
          </div>

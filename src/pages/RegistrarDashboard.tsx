      ...
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <Tabs defaultValue="overview" className="w-full">
          <TabsList className="grid w-full grid-cols-4">
            ...
            <TabsTrigger value="approvals">Enrollment Approvals</TabsTrigger>
          ...
          <TabsContent value="approvals" className="space-y-4">
            <h2 className="text-xl font-semibold">Enrollment & Consultation Approvals</h2>
            <EnrollmentApproval />
          </TabsContent>

          <TabsContent value="documents" className="space-y-4">
            <h2 className="text-xl font-semibold">Document Request Processing</h2>
            <DocumentProcessing />
          </TabsContent>
          ...
          <TabsContent value="reports" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Generate and view academic performance reports</CardDescription>
              </CardHeader>
              <CardContent>
